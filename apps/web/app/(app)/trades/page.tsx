  ...
  return (
    <div style={{ padding: '22px 26px 60px', maxWidth: 1400, width: '100%', alignSelf: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          <button
            style={{
              ...
              padding: '6px 11px', borderRadius: 7, border: '1px solid var(--eb-border)',
              background: 'var(--eb-panel-2)', color: 'var(--eb-text)', fontSize: 12,
          ...
          <button
            style={{
              display: 'inline-flex', alignItems: 'center', gap: 6,
              padding: '6px 13px', borderRadius: 7, border: '1px solid #00b67a',
      ...
      >
        ...
        <p style={{ color: 'var(--eb-muted-2)', margin: '0 0 20px', maxWidth: 460, marginInline: 'auto', lineHeight: 1.6, fontSize: 13.5 }}>
